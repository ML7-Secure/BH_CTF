...
client_server = [(0x49b, 0x49a), (0x58b, 0x58a), (0x590, 0x58f), (0x5d0, 0x5cf), (0x6a2, 0x682), (0x6a6, 0x686), (0x6a8, 0x688), (0x6a9, 0x689), (0x6ad, 0x68d), (0x6b4, 0x694), (0x6ba, 0x69a), (0x74a, 0x64a), (0x7ff, 0x64a), (0x7ff, 0x694), (0x6a2,0x682)]
...
def reset(i):
    out = subprocess.run(['./cc.py', '-i', 'can0', 'uds', 'ecu_reset', '3', str(client_server[i][0]), str(client_server[i][1])], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    res = out.stdout
    print(res.decode())
...
def main():
    ...
    i = 14 # 4, 7, 11, 12, 13 - not completed correctly //// 10 : all good
